...
// Test date
var date = {year: 2020, month: 4, day: 5, hour: 21};
...
*/
    ...
    swisseph.swe_heliacal_ut (julday_ut, [-71.13, 42.27, 0], [0, 0, 0, 0], [36, 1, 0, 0, 0, 0], 'Mercury', swisseph.SE_HELIACAL_RISING, flag, function (body) {
        ...
        swisseph.swe_revjul (body.startVisible, swisseph.SE_GREG_CAL, function (result) {
            console.log ('Mercury startVisible', result);
            console.log ('Mercury startVisible', result);
        });
    });
